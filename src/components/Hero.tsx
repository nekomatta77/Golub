    ...
    <section className="relative min-h-screen pt-24 pb-12 px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row items-center gap-12 bg-linear-to-b from-[#050505] to-[#121212] overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 relative z-10 flex justify-center mt-12 lg:mt-0">
        <div className="relative w-full max-w-lg">
          ...
          {/* ИСПРАВЛЕНО: Заменили Sparkles на Trophy (Кубок) */}
          <div className="absolute -bottom-6 -left-6 bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.6)] flex items-center gap-4 animate-[bounce_4s_ease-in-out_infinite]">
            <div className="w-12 h-12 bg-[#CCFF00]/10 text-[#CCFF00] rounded-xl flex items-center justify-center">
              <Trophy className="w-6 h-6" />
            </div>
            <div>
              <p className="text-sm text-stone-400 font-medium">Цель достигнута</p>
              <p className="text-xl font-bold text-white">-10 кг</p>
            </div>
          </div>
          
          <div className="absolute top-12 -right-8 bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.6)] flex items-center gap-4">
            
            {/* Идеально ровный кружок */}
            <div className="w-14 h-14 shrink-0 bg-[#00FFFF]/10 text-[#00FFFF] rounded-full flex items-center justify-center font-black text-base tracking-tighter border border-[#00FFFF]/20">
              100%
            </div>
            
            <div>
              <p className="text-sm font-bold text-white">Индивидуальный</p>
              <p className="text-xs text-stone-400 font-medium">План Питания</p>
            </div>
          </div>
        </div>
      </div>
