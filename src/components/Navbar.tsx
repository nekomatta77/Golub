  ...
  return (
    <nav className="absolute top-0 left-0 right-0 z-50 px-6 py-4 md:px-12 md:py-6 flex items-center justify-between">
      ...
      <div className="hidden md:block">
        <button className="bg-white/10 text-white px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-white/20 transition-all backdrop-blur-md border border-white/10">
          Вход
        </button>
      </div>
